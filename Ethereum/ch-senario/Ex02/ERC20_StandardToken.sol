...
contract SuperUltraPowerCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function SuperUltraPowerCoin() {
    	// balances, totalSupply : 만들고자 하는 토큰의 전체갯수 (예는 1000개)
        ...
        // name : 만들고자 하는 토큰명 (CodeDragonCoin)"
        name = "CodeDragonCoin";                                   // Set the name for display purposes (CHANGE THIS)
        ...
        //10으로 설정하였기 때문에 1이더를 전송하면 10 토큰을 받게 됩니다.
